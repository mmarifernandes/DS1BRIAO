...
.table tbody tr:last-of-type {
    border-bottom: 2px solid #30789c;
}
...
<body>
 ...
 function url($campo, $valor, $login)
        ...
        echo "<input type=\"text\" size=20 style=\"margin-top:25; margin-left: 200; position: absolute\" id=\"valor1\" name=\"valor1\" value=\"" . $value . "\" size=\"70\"> \n";
        ...
        echo "<select style='position: absolute; margin-left: 460; margin-top:27; padding: 4px; background-color: #fff; border:none;' id=\"campo\" name=\"campo\">\n";
        ...
        echo "</select>";
        echo "<a style='position: absolute; margin-left: 530; margin-top:30;' href=\"\" id=\"valida\" onclick=\" value = document.getElementById('valor1').value.trim().replace(/ +/g, '+'); result = '" . strtr(implode("&", $parameters) , " ", "+") . "'; result = ((value != '') ? document.getElementById('campo').value+'='+value+((result != '') ? '' : '') : '')+result; this.href ='home.php?'+((result != '') ? '' : '')+result;\">&#x1F50E;</a><br>\n";
        echo '</center>';
        ?>
